...
urlpatterns = [
    ...
    path('api/attendance-details/', views.attendance_detail_api, name='attendance-detail-api'),
    path('api/search-employees/', views.search_employees, name='search_employees'),
    path('api/calendar-events/', views.calendar_events, name='calendar_events'),
    path('api/attendance-details/', views.attendance_details, name='attendance_details'),
