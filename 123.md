...
<style>
    ...
    /* Make the modal scrollable on small screens */
    ...
    <div class="card-body">
        <form id="shift-assignment-form" method="post">
            ...
            <div class="mb-3">
                ...
                <div id="selectedEmployees" class="border rounded p-2" style="min-height: 100px;">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="select-buttons text-end mb-3">
                            ...
                            <div class="employee-list" style="max-height: 400px; overflow-y: auto;">
                                {% for employee in employees %}
                                <div class="form-check employee-item mb-2 p-2 border-bottom" data-department="{{ employee.department.name }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function filterEmployees() {
        ...
        document.querySelectorAll('.employee-item').forEach(item => {
            ...
            const number = checkbox.dataset.number.toLowerCase();
    ...
    function updateSelectedEmployees() {
        ...
        selectedEmployees.forEach(emp => {
            html += `<div class="selected-employee mb-1 d-flex justify-content-between align-items-center">
        ...
        selectedEmployeesDiv.innerHTML = html || '<div class="text-muted">No employees selected</div>';
        selectedEmployeeIds.value = selectedEmployees.map(emp => emp.id).join(',');
        selectedCountSpan.textContent = `(${selectedEmployees.length} selected)`;
    }
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3" id="nightShiftTimingFields" style="display: none;">
                        ...
                        <small class="text-muted">
                            Default start time for night shift schedule
                        </small>
                    </div>
                    ...
                    <div class="mb-3" id="nightShiftTimingFields_end" style="display: none;">
                        ...
                        <small class="text-muted">
                            Default end time for night shift schedule
                        </small>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Function to toggle night shift timing fields
    function toggleNightShiftFields() {
    ...
    // Check initial state
    toggleNightShiftFields();

    // Add toggle listener
    isNightShiftCheckbox.addEventListener('change', toggleNightShiftFields);
