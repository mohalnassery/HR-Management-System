        ...
        <div class="col-md-3 col-lg-2">
            ...
            <div class="list-group mb-4">
                ...
                <a href="{% url 'attendance:shift_list' %}"
                   class="list-group-item list-group-item-action {% if request.resolver_match.url_name == 'shift_list' %}active{% endif %}">
                    <i class="fas fa-list"></i> View Shifts
                </a>
                <a href="{% url 'attendance:shift_assignment_create' %}"
                   class="list-group-item list-group-item-action {% if request.resolver_match.url_name == 'shift_assignment_create' %}active{% endif %}">
